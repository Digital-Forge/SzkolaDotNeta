        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SerialItems_Items_IdItem",
                        column: x => x.IdItem,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SerialItems_ItemReservations_ItemReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerialItems_IdItem",
                table: "SerialItems",
                column: "IdItem");

            migrationBuilder.CreateIndex(
                name: "IX_SerialItems_ItemReservationId",
                table: "SerialItems",
                column: "ItemReservationId",
                unique: true,
                filter: "[ItemReservationId] IS NOT NULL");
